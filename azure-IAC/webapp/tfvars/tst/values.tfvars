...
# trackingapi config
sam_api_base_url        = "https://testelr.appservice.elr01.optum.com/"   # get from dev team
sam_api_daily_endpoint  = "api/AuditQuantamSamples/response_daily"        # get from dev team
sam_api_weekly_endpoint = "api/AuditQuantamSamples/response_weekly"       # get from dev team
...
quantam_ops2_url                = "http://ops2-test.mhars1.optum.com"
quantam_wtxdb_environment       = "WebTrax Test Server"
quantam_chart_image_handler     = "storage=file;timeout=20;"
quantam_disable_email_env       = "stage"
quantam2_0_url                  = "https://ase-quantam-2-0-centralus-tst.azurewebsites.net"         # fallback; keyvault.yaml overrides with custom domain
quantam_time_tracker_uri        = "https://ase-quantam-trackingapi-centralus-tst.azurewebsites.net" # fallback; keyvault.yaml overrides with custom domain
