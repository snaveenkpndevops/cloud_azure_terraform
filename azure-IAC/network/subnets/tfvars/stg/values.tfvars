...
nextgen_subnets = {
  pep = {
    ...
    address_prefix = "6.76.218.0/25" # Update with your desired CIDR block
    metadata = {
  ...
  webapp = {
    ...
    address_prefix = "6.76.217.0/25" # Update with your desired CIDR block
    metadata = {
      uhg_resource_group = "quantam-cloud-c7ffa72" # Must match VNet metadata
    }
    network_security_rules = [
  ...
  db = {
    name           = "snet-quantam-db-centralus-stg"
    address_prefix = "6.76.217.128/25" # Update with your desired CIDR block 
    metadata = {
      uhg_resource_group = "quantam-cloud-c7ffa72" # Must match VNet metadata
    }
    network_security_rules = [
  ...
  adf = {
    name           = "snet-quantam-adf-centralus-stg"
    address_prefix = "6.76.218.128/25" # Update with your desired CIDR block
    metadata = {
